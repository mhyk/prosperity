...
namespace ProsperitySurveyMVCApp.Controllers
{
    ...
    public class LocationsController : Controller
    {
        ...
        */
        ...
        public ActionResult Create([Bind(Include = "Id,Baranggay,City,Province")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Baranggay,City,Province")] Location location)
        {
            if (ModelState.IsValid)
            {
